 ...
 */
function parseDataFromRfc2822(d) {
  return new Date(d);
}
 ...
 */
function parseDataFromIso8601(d) {
  return +new Date(d);
}
 ...
 */
function timeSpanToString(x, y) {
  return new Date(y - x).toISOString().slice(11, 23);
}
